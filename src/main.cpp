...
void helper() {
  ...
  printf("\.\/%s\.exe -d 32.72 73.59 78.67 49.06 57.68 122.03 115.73 84.19 95.81 122.23\n",PROG_NAME);

  printf("\nYou can also pass arguments in a file with many calculations to do.\n");
  printf("For that use the flag \"-f\" instead of \"-d\" and then pass the path to the file \n");
  printf("Or just the name of the file if its in the same directory as the executable \n");
