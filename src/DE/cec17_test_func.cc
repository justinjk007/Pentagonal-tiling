...
void sum_diff_pow_func(double*, double*, int, double*, double*, int,
...
void ellips_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void sum_diff_pow_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void zakharov_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
                   int r_flag) /* zakharov */
{
    int i;
    sr_func(x, z, nx, Os, Mr, 1.0, s_flag, r_flag);  // shift and rotate
...
/* Dixon and Price */
void dixon_price_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void bent_cigar_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void discus_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
                 int r_flag) /* Discus */
{
    int i;
    sr_func(x, z, nx, Os, Mr, 1.0, s_flag, r_flag); /* shift and rotate */
...
void dif_powers_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void rosenbrock_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void schaffer_F7_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void ackley_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
                 int r_flag) /* Ackley's  */
{
    int i;
    double sum1, sum2;
...
void weierstrass_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void griewank_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void schwefel_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void katsuura_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
                   int r_flag) /* Katsuura  */
{
    int i, j;
...
void bi_rastrigin_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void grie_rosen_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void escaffer6_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void happycat_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void hgbat_func(double* x, double* f, int nx, double* Os, double* Mr, int s_flag,
...
void hf01(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
...
void hf02(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
...
void hf03(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
          int r_flag) /* Hybrid Function 2 */
{
    int i, tmp, cf_num = 3;
    double fit[3];
...
void hf04(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
...
void hf05(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
...
void hf06(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
...
void hf07(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
...
void hf08(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
          int r_flag) /* Hybrid Function 6 */
{
    int i, tmp, cf_num = 5;
    double fit[5];
...
void hf09(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
          int r_flag) /* Hybrid Function 6 */
{
    int i, tmp, cf_num = 5;
    double fit[5];
...
void hf10(double* x, double* f, int nx, double* Os, double* Mr, int* S, int s_flag,
          int r_flag) /* Hybrid Function 6 */
{
    int i, tmp, cf_num = 6;
    double fit[6];
...
void sr_func(double* x, double* sr_x, int nx, double* Os, double* Mr, double sh_rate, int s_flag,
...
void cf_cal(double* x, double* f, int nx, double* Os, double* delta, double* bias, double* fit,
            int cf_num)
{
    int i, j;
    double* w;
